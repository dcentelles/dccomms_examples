...
then
	...
	${bindir}/transport --tx-packet-size $size --num-trunks $trunks --num-packets $npkts --devDelay $devDelay  --node-name bluerov2_s100 --dcmac --add 1 --dstadd 0 --data-rate $datarate --log-file "$tx0applog" --ms-start 10000 --propSpeed $propSpeed -l $loglevel --maxRange $maxRange &
	tx0=$!

	echo "tx1"
	tx1applog="$rawlogdir/bluerov2_f_s100.log"
	${bindir}/transport --tx-packet-size $size --num-trunks $trunks --num-packets $npkts --devDelay $devDelay --node-name bluerov2_f_s100 --dcmac --add 2 --dstadd 0 --data-rate $datarate --log-file "$tx1applog" --ms-start 10000 --propSpeed $propSpeed -l $loglevel --maxRange $maxRange &
	tx1=$!

	echo "tx2"
	tx2applog="$rawlogdir/bluerov2_f2_s100.log"
	${bindir}/transport --tx-packet-size $size --num-trunks $trunks --num-packets $npkts --devDelay $devDelay --node-name bluerov2_f2_s100 --dcmac --add 3 --dstadd 0 --data-rate $datarate --log-file "$tx2applog" --ms-start 10000 --propSpeed $propSpeed -l $loglevel --maxRange $maxRange &
	tx2=$!

	echo "tx3"
	tx3applog="$rawlogdir/bluerov2_f3_s100.log"
	${bindir}/transport --tx-packet-size $size --num-trunks $trunks --num-packets $npkts --devDelay $devDelay --node-name bluerov2_f3_s100 --dcmac --add 4 --dstadd 0 --data-rate $datarate --log-file "$tx3applog" --ms-start 10000 --propSpeed $propSpeed -l $loglevel --maxRange $maxRange &
	tx3=$!

	echo "base"
	baseapplog="$rawlogdir/g500_s100.log"
	${bindir}/transport --tx-packet-size $mpktsize --num-trunks $trunks --num-packets $mnpkts --devDelay $devDelay --node-name g500_s100 --dcmac --master --add 0 --dstadd 1 --data-rate $mdatarate --log-file "$baseapplog" --ms-start 0 --propSpeed $propSpeed -l $loglevel --maxRange $maxRange & 
	base=$!
	...
	echo "tx0"
	tx0applog="$rawlogdir/bluerov2_s100.log"
	${bindir}/transport --tx-packet-size $size --num-trunks $trunks --num-packets $npkts --node-name bluerov2_s100 --dstadd 0 --data-rate $datarate --log-file "$tx0applog" --ms-start 10000 &
	tx0=$!

	echo "tx1"
	tx1applog="$rawlogdir/bluerov2_f_s100.log"
	${bindir}/transport --tx-packet-size $size --num-trunks $trunks --num-packets $npkts --node-name bluerov2_f_s100 --dstadd 0 --data-rate $datarate --log-file "$tx1applog" --ms-start 10000 &
	tx1=$!

	echo "tx2"
	tx2applog="$rawlogdir/bluerov2_f2_s100.log"
	${bindir}/transport --tx-packet-size $size --num-trunks $trunks --num-packets $npkts --node-name bluerov2_f2_s100 --dstadd 0 --data-rate $datarate --log-file "$tx2applog" --ms-start 10000 &
	tx2=$!

	echo "tx3"
	tx3applog="$rawlogdir/bluerov2_f3_s100.log"
	${bindir}/transport --tx-packet-size $size --num-trunks $trunks --num-packets $npkts --node-name bluerov2_f3_s100 --dstadd 0 --data-rate $datarate --log-file "$tx3applog" --ms-start 10000 &
	tx3=$!

	echo "base"
	baseapplog="$rawlogdir/g500_s100.log"
	${bindir}/transport --tx-packet-size $mpktsize --num-trunks $trunks --num-packets $mnpkts --node-name g500_s100 --dstadd 1 --data-rate $mdatarate --log-file "$baseapplog" --ms-start 0 & 
	base=$!
